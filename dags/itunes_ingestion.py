...
def pull_from_itunes_and_upload_to_s3(artist_list, bucket_name, s3_key_prefix):
    ...
    s3 = boto3.client('s3',aws_access_key_id='AKIAXSLCGTCHISVPV2BY',
        aws_secret_access_key='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')
...
pull_and_store_itunes_data = PythonOperator(
    ...
    op_kwargs={
        ...
        'aws_access_key': 'AKIAXSLCGTCHISVPV2BY',
        'aws_secret_key': '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',
    },
    dag=dag,
)
